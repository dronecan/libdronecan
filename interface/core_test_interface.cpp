#include "core_test_interface.h"

using namespace CubeFramework;

void CoreTestNetwork::route_msg(CoreTestInterface *send_iface, uint8_t source_node_id, uint8_t destination_node_id, Transfer transfer) {
...
bool CoreTestInterface::broadcast(Transfer bcast_transfer) {
    // call network router
...
bool CoreTestInterface::request(uint8_t destination_node_id, Transfer req_transfer) {
    // call network router
...
bool CoreTestInterface::respond(uint8_t destination_node_id, Transfer res_transfer) {
    // call network router
