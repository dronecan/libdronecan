...
bool CanardInterface::broadcast(Transfer bcast_transfer) {
    // do canard broadcast
...
bool CanardInterface::request(uint8_t destination_node_id, Transfer req_transfer) {
    // do canard request
...
bool CanardInterface::respond(uint8_t destination_node_id, Transfer res_transfer) {
    // do canard respond
    return canardRequestOrRespond(&canard,
                                    destination_node_id,
